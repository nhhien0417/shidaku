...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    private void LerpToPage(int aPageIndex)
    {
        ...
        _currentPage = aPageIndex;
        if (currentTab != null)
            currentTab.text = "" + (_currentPage + 1);
    }
    ...
    private void SetPageSelection(int aPageIndex)
    {
        ...
        {
            _pageSelectionImages[_previousPageSelectionIndex].sprite = unselectedPage.sprite;
            _pageSelectionImages[_previousPageSelectionIndex].color = unselectedPage.color;
        }

        // select new
        _pageSelectionImages[aPageIndex].sprite = selectedPage.sprite;
        _pageSelectionImages[aPageIndex].color = selectedPage.color;
